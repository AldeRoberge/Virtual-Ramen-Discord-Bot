...
using VirtualRamenDiscordBot.Channels.Welcome;
...
/// </summary>
public class InfoChannel : ChannelGenerator
{
    public override Channel Channel => new()
    {
        Id = ChannelConstants.Info,
        Name = "「📋」infos",
        Topic = "Liens importants",
        ChannelsEnum = ChannelsEnum.Info
    };
